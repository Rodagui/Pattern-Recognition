...
for j in range(numClase):
	...
	for i in range(numPuntos):
		...
		#________para vecino más cercano______________#
		todosLosPuntos.append((x, y, j+1))
...
if(opcion == '3'):
	...
	for i in range(len(distancias)):
		d= distancias[i]
		print('La probabilidad con la clase {} y el punto es {}%'.format(i + 1, d))
...
#-----------------------Vecino más cercano---------------------------------------#
if(opcion == '4'):
	claseP = calcularVecinosMasCercanos(equis, ye, todosLosPuntos)
